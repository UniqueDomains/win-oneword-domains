# Available .WIN One-Word Domains (5,622,101)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C979%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C101%20domains-6f42c1">
...
> **Important:** this repository is a **public 8,979-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,101 domains** on the canonical page below.

**Public extract:** 8,979 rows · **Live catalog:** 5,622,101 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/win?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_win_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/win?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_win_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./win.csv">CSV</a> / <a href="./win.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_win_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_win_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .WIN search](https://unique.domains/domains/tld/win?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_win_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .WIN search](https://unique.domains/domains/tld/win?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_win_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./win.csv) or [Download JSON](./win.json)
...
- `win.csv` — public CSV extract (8,979 rows)
- `win.json` — public JSON extract (8,979 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,979-row public sample | 5,622,101 live domains                           |
...
| -------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------------------------------------------------------- |
| building.win   | available | $9.98     | —             | 74             | 28     | 8      | namecheap                                                 |
| taiwan.win     | resell    | —         | —             | 66             | 92     | 6      | Global Domains International, Inc. DBA DomainCostClub.com |
| converse.win   | premium   | $437.50   | $62.50        | 64             | 73     | 8      | name.com                                                  |
...
| blue.win       | resell    | —         | —             | 92             | 59     | 4      | Porkbun                                                   |
| seventeen.win  | premium   | $437.50   | $62.50        | 84             | 62     | 9      | name.com                                                  |
| academic.win   | available | $9.98     | —             | 96             | 22     | 8      | namecheap                                                 |
...
| clear.win      | premium   | $437.50   | $62.50        | 90             | 50     | 5      | name.com                                                  |
...
| accessible.win | available | $9.98     | —             | 78             | 21     | 10     | namecheap                                                 |
| one.win        | resell    | —         | —             | 132            | 51     | 3      | Dynadot Inc                                               |
...
> Unique Domains. *Available .WIN One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
